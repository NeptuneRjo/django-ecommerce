...
class StoreItem(models.Model):
    item_category = models.CharField(max_length=454, default='')
    item_description = models.CharField(max_length=454, default='')
    item_image_url = models.CharField(max_length=454, default='')
    ...
    item_title = models.CharField(max_length=454, default='')
    item_id = models.AutoField(primary_key=True)
